...
>    - `framework/` — канонические универсальные шаблоны (двенадцать ключевых документов вкл. пояснительную записку `KAIF_REFERENCE.md`, шесть README директорий, тридцать навыков, опциональные модули и скрипт-распаковщик).
...
6 README + 30 навыков + 1 распаковщик = 49; бандл 141 блок; карта — 586 модулей) — не переписывай эти
