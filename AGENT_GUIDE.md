...
>    - `framework/` — канонические универсальные шаблоны (тринадцать ключевых документов вкл. летопись `PROJECT_HISTORY.md` и пояснительную записку `KAIF_REFERENCE.md`, шесть README директорий, тридцать навыков, опциональные модули и скрипт-распаковщик).
...
6 README + 30 навыков + 1 распаковщик = 50; бандл 142 блока; карта — ~590 модулей) — не переписывай эти
