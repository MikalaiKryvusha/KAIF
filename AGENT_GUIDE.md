...
>    - `framework/` — канонические универсальные шаблоны (двенадцать ключевых документов вкл. пояснительную записку `KAIF_REFERENCE.md`, шесть README директорий, двадцать восемь навыков, опциональные модули и скрипт-распаковщик).
