...
>    - `framework/` — канонические универсальные шаблоны (девять ключевых документов, шесть README директорий и восемнадцать навыков).
...
блоки `FILE:` в `KAIF.md` сбалансированы и полны (динамический подсчёт: 9 ключевых документов + 6 README + 18 навыков = 33); (3) ссылки на
