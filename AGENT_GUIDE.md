...
>    - `framework/` — канонические универсальные шаблоны (одиннадцать ключевых документов, шесть README директорий, двадцать восемь навыков, опциональные модули и скрипт-распаковщик).
