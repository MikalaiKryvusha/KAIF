...
Этот репозиторий — **KRINIKS AI Agent Framework**, и он **обёрнут самим фреймворком** (dogfooding).
Перед каждой задачей:

1. Прочитай **`AGENT_GUIDE.md`** — канон работы над этим проектом (учти фрактальную двухслойную
   структуру: *полезная нагрузка* `framework/` + сгенерированный `FRAMEWORK.md` vs. эта *обвязка для
   dogfooding*).
...
⚠️ **Критическое правило:** самораспаковывающееся ядро `FRAMEWORK.md` **генерируется** — никогда не правь
...
`FRAMEWORK.md` — а не из файлов обвязки этого репозитория.
