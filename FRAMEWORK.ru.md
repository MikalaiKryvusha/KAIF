...
# KRINIKS — фреймворк для AI-агентов
...
> **Лицензия:** MIT · **Репозиторий:** https://github.com/MikalaiKryvusha/kriniks_ai_agent_framework
...
1. **Полное описание** фреймворка KRINIKS — его философии, структуры, соглашений и навыков.
2. **Установщик.** Передайте этот единственный файл AI-агенту и скажите: *«распакуй фреймворк KRINIKS в этот
...
смотрите (`kriniks_ai_agent_framework`), *использует фреймворк на самом себе*. В его собственном корне есть
...
- `git add -A && git commit -m "chore: deploy KRINIKS AI agent framework"` (с трейлером Co-Authored-By).
...
2. В своём агенте скажите: *«Прочитай FRAMEWORK.md и распакуй фреймворк KRINIKS в этот проект.»*
