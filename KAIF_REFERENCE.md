<!-- GENERATED COPY — do not edit. Source: framework/KAIF_REFERENCE.md (edit there, then run tools/build-framework.mjs). Deployed projects receive this document at .kaif/KAIF_REFERENCE.md. -->
