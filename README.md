...
3. The sandbox polygon (27 suites) verifies the deploy/update machinery; the methodology itself is
...
3. Песочный полигон (27 сводов) проверяет машинерию развёртывания и обновления; сама методология
