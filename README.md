...
3. The sandbox polygon (21 suites) verifies the deploy/update machinery; the methodology itself is
...
3. Песочный полигон (21 свод) проверяет машинерию развёртывания и обновления; сама методология
