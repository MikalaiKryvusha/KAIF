...
├── plans/                    # MASTER_PLAN.md (roadmap) · PROJECT_STRUCTURE_EXTERNAL_MAP.md (architecture) · ideas/
...
├── plans/                    # MASTER_PLAN.md (генплан) · PROJECT_STRUCTURE_EXTERNAL_MAP.md (архитектура) · ideas/
