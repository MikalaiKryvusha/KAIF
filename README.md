...
3. The sandbox polygon (24 suites) verifies the deploy/update machinery; the methodology itself is
...
3. Песочный полигон (24 свода) проверяет машинерию развёртывания и обновления; сама методология
