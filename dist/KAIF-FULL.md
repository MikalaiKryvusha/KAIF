...
# KAIF — Krinik AI Framework · the self-extracting core · v2.2
...
├── .claude/skills/     # the repeatable rituals (slash-skills) — 35 in all (or the agent's equivalent)
...
```json
{ "framework": "KAIF", "version": "2.2", "released": "2026-08-08",
