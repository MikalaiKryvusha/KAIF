...
**Создан:** · **Родитель:** · **Статус:** · **Вовне:** (`AGENT_GUIDE.md` → «Шапка-мета
документов»). После реализации впиши статус и дату в файл и пометь `DONE`
(`git mv NN_x.md NN_DONE_x.md`).

> В этом репозитории здесь также лежат исторические идеи 01–05, по которым развивался сам KAIF.
