...
> Статус: **✅ DONE (2026-07-01)** — реализовано в v1.1. Источник требований: `ideas/05_DONE_structured_KAIF.md` (21 пункт).
...
Все 21 требование реализованы в релизе v1.1. Сборка и самопроверка зелёные (33 FILE-блока). Детали — `STATUS.md`.
