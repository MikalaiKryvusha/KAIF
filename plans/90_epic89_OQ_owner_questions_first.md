...
> issues #46/#47, `bugs/111`. **Вовне:** правки канона поставки (`framework/AGENT_GUIDE.md`,
...
- [ ] **OQ0 — нулёвка актуализации входов (№76).** Сверить против HEAD: поставка `/resume` без
...
- [ ] **OQ1 — факт «показан», возраст, условие выхода (критерии 1–4).**
...
- [ ] **OQ3 — исток мерит себя (критерий 8).** `SYSTEMS_REGISTRY.md` истока из инвентаря
...
(заполняется по ходу; на старте — пять развилок донора закрыты агентом, `researches/27` §4)
