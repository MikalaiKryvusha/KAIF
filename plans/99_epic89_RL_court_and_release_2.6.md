...
- [ ] **RL5 — публикация (критерий 3, слово владельца №13).** Слово владельца — интервью №030: раунд 1 (интервью №030, Q1 = C, 12:36) — четыре вопроса («Заставка нарисована? Релиз ноутсы написаны? README обновлен под новую версию? Все доделано по 2.6…»), отвечены раундом 2 (Q2) живыми ссылками; публикация — по ответу Q2. `/release` шаги 0–7: предпроверка · README · PDF ·
