# Handoff AQ — эпик «Вопрос владельцу — после археологии» (`plans/115`, критерий 25 `plans/100`, issue #70) <!-- questions-guard:allow имя эпика в заголовке передачи, а не очередь вопросов; место вопросов — interviews/ -->
...
> **ВНЕСЕНО интегратором 2026-09-18 10:17 +03:00 (сессия 66, Fable 5.1):** § 2 охота и сводная строка — обе копии судьи побайтно ✅ · § 3 запись 2.7 ✅ · § 4 политика ✅ · § 5 шесть пар ✅ · § 6 строки `plans/100` ✅ · § 8 урок → EXP-0140 ✅ · README 797 → живое число после слияния EL ✅ (одним движением со слиянием EL) · § 7 черновик ответа #70 остаётся ЗДЕСЬ до релиза (отправка — №84/№92/№93). Файл не удалён, а переименован в `_DONE` — по образцу передач SF и FR (каверза судьи интеграции: удалённая передача уносит черновик ответа).
