...
- [ ] **Черновик ответа #67** (§ 4) — отправка только после релиза 2.7 и только словом владельца. (единственный открытый пункт) <!-- closed-ok: отправка ответа #67 — после релиза 2.7 и только словом владельца; пункт ведёт plans/116, шаг RL3 -->
