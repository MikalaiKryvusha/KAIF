...
- **≈ 396,000 words of prose written during the work on the version** — more than Anna Karenina; ≈ 104,000 of them went into the KAIF 2.2 core itself, more than The Hobbit.
...
- **≈ 396 000 слов прозы написано за время работы над версией** — больше, чем «Анна Каренина»; в само ядро KAIF 2.2 из них вошло ≈ 104 000 слов, больше «Хоббита».
