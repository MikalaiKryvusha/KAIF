...
**Родитель:** · **Статус:** · **Вовне:** (`AGENT_GUIDE.md` → «Шапка-мета документов»). Конспект
исследования — **живой справочник**, а не закрываемая
задача: тегом `DONE` не помечается, обновляется по мере роста понимания.

> Директория заведена в версии 1.1; наполняется по мере появления крупных исследований.
