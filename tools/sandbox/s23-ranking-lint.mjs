...
// [TESTED: 2026-09-05 · стоя — все проверки зелёные (установка · selftest · #53 → exit 1 с шестью находками (поправка суда RL 2.6: и `order`) · исправленный → 0 ·
...
writeFileSync(join(P, 'drafts', 'what-next-53.md'), [
  ...
  '| 3. Серия трафика: индексация каталога | критерий 3 | bugs/12 | 0,5 чата |', '',
].join('\n'));
